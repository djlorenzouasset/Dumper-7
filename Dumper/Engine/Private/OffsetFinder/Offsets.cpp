...
void Off::InSDK::ProcessEvent::InitPE_Windows()
{
	...
	auto IsProcessEvent = [](const uint8_t* FuncAddress, [[maybe_unused]] int32_t Index) -> bool
	{
		return (Platform::FindPatternInRange({ 0xF7, -0x1, Off::UFunction::FunctionFlags, 0x0, 0x0, 0x0, 0x0, 0x04, 0x0, 0x0 }, FuncAddress, 0x400)
			...
			// The Outlast Trials: from CL 192745 the process event function has been changed with inlined function calls inside breaking the PE finder
			|| (Platform::FindPatternInRange({ 0xF6, 0x87, -0x1, -0x1, -0x1, -0x1, -0x1, 0x0F, 0x85, -0x1, -0x1, -0x1, -0x1 }, FuncAddress, 0xF00)
			&& (Platform::FindPatternInRange({ 0x41, 0xF6, 0x86, -0x1, -0x1, -0x1, -0x1, -0x1, 0x0F, 0x85, -0x1, -0x1, -0x1, -0x1 }, FuncAddress, 0xF00)
			|| Platform::FindPatternInRange({ 0x41, 0xF6, 0x85, -0x1, -0x1, -0x1, -0x1, -0x1, 0x0F, 0x85, -0x1, -0x1, -0x1, -0x1 }, FuncAddress, 0xF00)));
	};
#elif defined(_WIN32)
	/* Primary, and more reliable, check for ProcessEvent */
	auto IsProcessEvent = [](const uint8_t* FuncAddress, [[maybe_unused]] int32_t Index) -> bool
